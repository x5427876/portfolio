        ...
        <div className="w-[80%] text-white py-12">
            ...
            <div className={`text-xl md:text-2xl ${roboto.className}`}>
                <p className="leading-loose">
                    ...
                    as a Frontend Developer crafting thoughtful and inclusive
                    experiences that adhere to web standards for over a hundred
                    merchants across Taiwan and Hong Kong.
                </p>
