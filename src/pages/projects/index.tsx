                ...
                <div className="rounded-lg border-2 border-gray-500 p-5 flex flex-col md:flex-row">
                    <div className="md:w-1/2">
                        ...
                        <div className="py-6 md:mr-8 leading-relaxed">
                            ...
                            recently played tracks, you can click to listen to
                            songs directly.
                        </div>
                        <Link
                            className="flex items-center justify-center cursor-pointer bg-white p-2 rounded-lg w-1/3 mb-6"
                            href="https://github.com/x5427876/spotify-profile"
                            target="_blank"
                        >
                            <p className="mr-2 text-black">Github</p>
                            <LinkIcon className="fill-black w-[12px] h-[12px]" />
                        </Link>
                    </div>
